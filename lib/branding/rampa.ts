 ...
 *
 * A régua é `app/globals.css`. `rampaDeSemente('#1447e6')` reproduz os 11 stops azuis
...
/**
 * Lightness dos 11 stops azuis, medida em OKLab a partir de `app/globals.css`.
 ...
 * uma cor no campo e outra na tela custa caro.
 */
